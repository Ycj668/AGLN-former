...
##########  data
subjectList = [str(i) for i in range(1, 16)]    # 从1-15的整数序列 使用str()函数将每个整数转换为字符串类型
clip_num_list = ['1', '3', '5', '6', '8', '9', '10', '12', '13', '15']
